...
preflight() {
  ...
  for command in gum jq lsblk sfdisk sgdisk blkid nix nix-instantiate nixos-install git findmnt findfs losetup mountpoint; do require_command "$command"; done
